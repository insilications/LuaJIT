...
Version  : 2.1.0.beta3
Release  : 13
URL      : file:///insilications/build/clearlinux/packages/LuaJIT/LuaJIT-v2.1.0-beta3.zip
Source0  : file:///insilications/build/clearlinux/packages/LuaJIT/LuaJIT-v2.1.0-beta3.zip
...
%prep
%setup -q -n LuaJIT-v2.1.0-beta3
cd %{_builddir}/LuaJIT-v2.1.0-beta3
%patch1 -p1
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597237979
